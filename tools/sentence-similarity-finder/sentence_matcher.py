...
#PDF_INPUT_FILE="/Users/TIMAC044/Documents/Anuvaad/sentences_comparison/PDF_TOKENIZED_SENTENCES/*"
# <sentence>
IK_INPUT_FILE="/user/root/sim-score/input/scrapped_sentences_full/ik_data_final.csv"
#IK_INPUT_FILE="/Users/TIMAC044/Documents/Anuvaad/sentences_comparison/IK_SCRAPPED/indian_kanoon_scrapped_sentences.csv"
...
matched_df = spark.sql('select b.sentence as ik_sentence, \
                               filename \
                        from \
...
diff_df = IK_FILE_DF_CLEAN.select("sentence").subtract(matched_df.select("ik_sentence"))

diff_df.write.csv('/tmp/invalid_ik_sentence/')
